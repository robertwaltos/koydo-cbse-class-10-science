...
export const metadata: Metadata = {
  title: "Pricing — Cbse Class 10 Science Premium",
  description: "Unlock unlimited Cbse Class 10 Science practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=cbse-class-10-science&cadence=annual`;
