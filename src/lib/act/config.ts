// Auto-generated shim — re-exports from @/lib/cbse-class-10-science/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _cbse_class_10_science_Config } from "@/lib/cbse-class-10-science/config";
import { EXAM_CONFIG as _raw } from "@/lib/cbse-class-10-science/config";
